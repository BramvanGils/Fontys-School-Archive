    ...
    public partial class Mainform : Form
    {
        ...
        private void messageReadTimer_Tick(object sender, EventArgs e)
        {
            if (myEV3.isConnected)
            {
                ...
                if (strMessage == "A*B*C*D*E*F*G*H*I*J*K*L*")
                {
                    MAINFRAME.CompletionRecordsEncrypted = strMessage;
                }
            }
        }
        ...
        // Navigate to Menu
        private void buttonMainformTerug_Click_1(object sender, EventArgs e)
        {
            MAINFRAME.ReopenForm = false;
            Close();
        }

        // Navigate to Staistics
        private void ButtonStatestieken_Click(object sender, EventArgs e)
        {
