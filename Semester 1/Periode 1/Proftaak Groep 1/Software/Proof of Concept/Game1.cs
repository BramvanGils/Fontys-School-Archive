...
namespace ProofOfConcept
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (!FireBallShot)
            {
                FireBallPosition.X = RobotPosition.X + 100;
                FireBallPosition.Y = RobotPosition.Y + 100;
            } 
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(DefaultFont, "Proof of Concept", Vector2.Zero, Color.Purple);
